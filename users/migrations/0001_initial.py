    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=0, size=[350, 350], upload_to='images/users/avatars/%d%m%Y')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.DateField(blank=True, null=True, verbose_name='Год основания')),
                ('logo', models.ImageField(blank=True, null=True, upload_to='images/provider/logo/%d%m%Y/', verbose_name='Логотип')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('Все', 'Весь Кыргызстан'), ('Чуй', 'Чуйская область'), ('Нарын', 'Нарынская область'), ('Баткен', 'Баткенская область'), ('Талас', 'Таласская область'), ('Ош', 'Ошская область'), ('Джалал-Абад', 'Джалал-Абадская область'), ('Иссык-Куль', 'Иссык-Кульская область')], default=1, max_length=30, verbose_name='Регион')),
