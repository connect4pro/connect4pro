...
from grants_and_investments.views import GrantsList, GrantDetail, GrantCommentCreate, GrantCommentList, InvestList, \
    InvestDetail, InvestCommentList, InvestmentCommentCreate
