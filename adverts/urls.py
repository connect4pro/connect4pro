...
urlpatterns = [
    ...
    path('api/businessadverts/comment/create_comment', BusinessAdvertCommentCreate.as_view(),
         name='businessadvert_comment_create'),
    path('api/provideradverts/comment/create_comment', ProviderAdvertCommentCreate.as_view(),
